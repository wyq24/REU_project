...
workdir='/Volumes/WD6T/working/20220511/eovsa_full/'
...
refms = workdir+'msdata/IDB20170820_1950_2050.ms'
...
refms_slfcaled = '/Volumes/Data/20170820/eovsa/msdata/IDB20170820_1950_2050.ms.XXYY.slfcaled'
...
init_time='2017-08-20T19:30:40.002'
time_interval=10.0
tranges=[]
tname=[]
...
start_time = Time('2017-08-20 19:38:23',format='iso')
end_time = Time('2017-08-20 19:38:28',format='iso')
#find the phasecenter
...
sbeam = 40.
bmsize = sbeam * 3.42343750e+09 / np.asarray(cfreqs, dtype=float)
...
for t in range(180):
    trange=tranges[t]
    slfcaledms_ = workdir+'slfcal/IDB20170820.ms.t{0:d}.XXYY.slfcaled'.format(t)
...
for t,trange in enumerate(tranges):
    subms_ = workdir+'slfcal/IDB20170909.ms.t{0:d}.slfcal'.format(t)
    slfcalms_ = workdir+'slfcal/IDB20170909.ms.t{0:d}.XXYY.slfcal'.format(t)
    slfcaledms_ = workdir+'slfcal/IDB20170909.ms.t{0:d}.XXYY.slfcaled'.format(t)
...
if dofinalclean:
    ...
    #    masks_a=pickle.load(open(workdir+'slfcal/masks_a.p','rb'),encoding='latin1')
    for t,trange in enumerate(tranges):
        trange=tranges[t]
        ...
        for s,sp in enumerate(spws):
            ...
            imname=img_final+'_s{0:0=2d}'.format(sp)
...
if doclean_slfcaled:
    ...
    for t,trange in enumerate(tranges):
        ...
        img_final=imagedir_slfcaled+'slfcaled_tb_final_XX_1s_{0}_t{1:d}'.format(pol,t)
        #masks=masks_a[t]
        #spws=[str(s+1) for s in range(30)]
        #tb.open(slfcaledms+'/SPECTRAL_WINDOW')
